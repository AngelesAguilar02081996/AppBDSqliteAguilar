...
public class MainActivity extends AppCompatActivity { //Inicia clase
    ...
    public Button btnAbrirListaProd, btnAudioVideo;
    ...
    protected void onCreate(Bundle savedInstanceState) { //Inicia metodo onCl¿reate
        ...
        etUbicacion=findViewById(R.id.etUbiacion);
        ...
        btnAbrirListaProd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent abrirVentanaListProd= new Intent(view.getContext(),ListaProductos.class);
                startActivityForResult(abrirVentanaListProd,0);
            }
        });
